...
class PublicUserAPITests(TestCase):
    ...
    def test_token_for_User_with_invalid_password(self):
        """Test returns error if password invalid."""
    ...
    def test_token_for_User_with_invalid_email(self):
    ...
    def test_token_for_User_with_blank_password(self):
